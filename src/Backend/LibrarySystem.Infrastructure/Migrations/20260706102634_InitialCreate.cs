    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                .Annotation("SqlServer:TemporalHistoryTableName", "FundsHistory")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubfieldsDefinition = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarcDictionaries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarcTemplates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SruTargets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhysicalItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BibliographicRecords_MarcTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "MarcTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "TemplateFieldConfigs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TemplateId = table.Column<int>(type: "int", nullable: false),
                    Tag = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AllowedSubfields = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsRequired = table.Column<bool>(type: "bit", nullable: false),
                    DefaultValue = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateFieldConfigs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateFieldConfigs_MarcTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "MarcTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                .Annotation("SqlServer:IsTemporal", true)
                .Annotation("SqlServer:TemporalHistoryTableName", "PurchaseOrdersHistory")
                .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookLoans_PhysicalItems_PhysicalItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BibliographicRecordId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrderLines_BibliographicRecords_BibliographicRecordId",
                        column: x => x.BibliographicRecordId,
                        principalTable: "BibliographicRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchaseOrderLines_Funds_FundId",
                        column: x => x.FundId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceLines_PurchaseOrderLines_PurchaseOrderLineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pieces_PurchaseOrderLines_PurchaseOrderLineId",
                        column: x => x.PurchaseOrderLineId,
                        principalTable: "PurchaseOrderLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BibliographicRecords_TemplateId",
                table: "BibliographicRecords",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_BookLoans_PhysicalItemId",
                table: "BookLoans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLines_PurchaseOrderLineId",
                table: "InvoiceLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalItems_CatalogId",
                table: "PhysicalItems",
                column: "CatalogId");

            migrationBuilder.CreateIndex(
                name: "IX_Pieces_PurchaseOrderLineId",
                table: "Pieces",
                column: "PurchaseOrderLineId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderLines_BibliographicRecordId",
                table: "PurchaseOrderLines",
                column: "BibliographicRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderLines_FundId",
                table: "PurchaseOrderLines",
                column: "FundId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateFieldConfigs_TemplateId",
                table: "TemplateFieldConfigs",
                column: "TemplateId");
